...
class CCNetworkCreator(QWidget):
    ...
    def updateActiveShaderBox(self, *args):
        ...
        cmds.select(selectedShaderName, r=True)
    ...
    def createAIImg(self, *args):
        ...
        self.textboxesArr = [[self.ui.INtexture1, self.ui.fileBox1], [self.ui.INtexture2, self.ui.fileBox2],
                             [self.ui.INtexture3, self.ui.fileBox3], [self.ui.INtexture4, self.ui.fileBox4]]
    ...
    def openDialog(self, *args):
        ...
        filePath = cmds.fileDialog2(fileFilter=multipleFilters, dialogStyle=2, fileMode=1, caption="Select texture",
                                    okCaption="Select")[0]
        return filePath
    ...
    def connectCCNetwork(self, *args):
        ...
        for i in range(0, 3):
            ...
            textureNodeList.append(currentTextureName)
